...
class App extends Component {
    render() {
        const {user: {userName, userPhone, userMail, userPhoto}, isAuthenticated} = this.props.users
            ...
            <>
                ...
                <div className="App">
                    <Switch>
                        ...
                        <AuthorizedRoute isApproved={user} path="/main" component={Main}/>
                        <AuthorizedRoute isApproved={user} path="/smart" component={Smart}/>
                        <AuthorizedRoute isApproved={user} path='/mytrips' component={TripsHistoryForm}/>
                        <AuthorizedRoute isApproved={user} path='/newtrip' component={NewTrip}/>
