...
import {setAuthorization, setLoginRejected, setSocialAuth} from "../../actions/userCreators";
...
class TripsHistory extends Component {
    ...
    componentDidMount(){
       this.props.fetchTripsHistory()
    }

    handleDelete = (id) => {
        let newTripsHistory = this.props.users.tripsHistory.map(item => {
