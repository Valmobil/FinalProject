...
public class LineXy {
  ...
  //  private static final double meters_per_deg_lat = 111132.954
  //  - 559.822 * Math.cos( 2 * kyivKhreschatikLatitude ) + 1.175 * Math.cos( 4 * kyivKhreschatikLatitude);
  ...
  //    double distance;
  //    distance = Math.pow((this.point2.getX() - this.point1.getX()), 2)
  //    - Math.pow((this.point2.getY() - this.point1.getY()), 2);
  //    if (distance == 0) {
  //      distanceOfTwoPoints(p, this.point1);
  //    } else {
  //      double tx = (((p.getX() - point1.getX()) * (point2.getX()
  //      - point1.getX()) + (p.getY() - point1.getY()) * (point2.getY() - point1.getY())) / distance);
  //      if (tx < 0)
  //        distanceOfTwoPoints(point1, p);
  //      else if (tx > 1)
  //        distanceOfTwoPoints(point2, p);
  //      else {
  //        PointXy pp = new PointXy(point1.getX() + tx * (point2.getX()
  //        - point1.getX()), point1.getY() + tx * (point2.getY() - point1.getY()));
