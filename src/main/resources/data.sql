...
insert into user (user_Id, user_Name, user_Phone, user_Password, user_Mail, user_Photo, user_Token_Access, user_Token_Access_To) values (2, 'Marichka', '+380679984536', '12345', 'marichka@gmail.com', '/UserPhotos/3.jpg', '', '2019-03-21 21:30:55')
insert into user (user_Id, user_Name, user_Phone, user_Password, user_Mail, user_Photo, user_Token_Access, user_Token_Access_To) values (2, 'Galynka', '+380503337744', '12345', 'galynka@gmail.com', '/UserPhotos/4.jpg', '', '2019-03-21 21:30:55')
...
insert into TRIP_PASSENGER (TRIP_PASSENGER_ID, TRIP_PASSENGER_DRIVER_TRIP_ID,  	TRIP_PASSENGER_TRIP_ID) values (1, 1, 4)
insert into TRIP_PASSENGER (TRIP_PASSENGER_ID, TRIP_PASSENGER_DRIVER_TRIP_ID,  	TRIP_PASSENGER_TRIP_ID) values (2, 2, 3)